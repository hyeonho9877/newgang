...
function search(e) {
    axios.post("http://localhost:8120/wishlist")
        .then((res) => console.log(res.data))
        .catch((err) => console.log(err));
}

class EnrollContents extends Component {
        ...
        return (
            <div className="enrollContainer">
                <div className="enrollContents">
                    ...
                    보라. 없으면, 싶이 보는 실로 봄날의 인생을 내려온 아니다. 그들은 따뜻한 황금시대를 싹이 보는 오직 피고, 않는 것은 철환하였는가? 황금시대의 바이며, 자신과 밥을 광야에서 수
                    길지
                ...
                <div className="selectbox">
                    ...
                    <Button variant="contained" onClick={search}>조회</Button>
                </div>
                <Table>
                    <TableHead>
                        <TableRow>
